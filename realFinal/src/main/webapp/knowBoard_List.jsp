	...
	<div class="wholeDiv">
		...
		<div class="board_list_wrap">
			...
			<form action="knowBoard_write.do" method="post" class="write bt_wrap">
				<input type="submit" value="글 쓰기" name="write" class="writeBtn">
										...
										function() {
											...
											$
													.ajax({
														...
														//----------------------------------
														success : function(
																ajaxData) { // ajaxData : 그냥 아무 변수명을 쓰면된다, 뭐 data라고 써도되고
																	...
																	.each(
																			...
																			function(
																				...
																				let tagHtml = "<tr class='currentList'>"
																						...
																						+ "'>"
																						+ "["
																						+ ajaxData['jsonList'][index]['subject']
																						+ "] "
																						+ ajaxData['jsonList'][index]['title']
																						+ "</a>"
																						+ "</td> "
																						+ "<td>"
																						+ ajaxData['jsonList'][index]['writer']
																						+ "</td> "
																						+ "<td>"
